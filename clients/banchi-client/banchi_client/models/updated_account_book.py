...
T = TypeVar("T", bound="UpdatedAccountBook")


@_attrs_define
class UpdatedAccountBook:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_account_book.additional_properties = d
        return updated_account_book
